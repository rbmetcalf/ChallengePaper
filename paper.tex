...
\author[R. B. Metcalf {\it et al.}]{R. Benton Metcalf,$^{1,4}$\thanks{E-mail: robertbenton.metcalf@unibo.it} 
M. Meneghetti,$^4$ 
...
\red{B: would be nice to have a figure about the resnet architecture}
