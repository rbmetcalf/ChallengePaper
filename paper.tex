...
\newauthor
Jean-Paul Kneib,$^6$
L\'{e}on V. E. Koopmans,$^{21}$
\newauthor
Fran\c{c}ois Lanusse,$^{19}$ 
Chun-Liang Li,$^{20}$
Quanbin Ma,$^{20}$ 
\newauthor
Martin Makler,$^{18}$
...
Matthew Lightman,$^{15}$
\newauthor
Carlo Enrico Petrillo,$^{21}$
Christoph Sch\"{a}fer,$^6$ 
Alessandro Sonnenfeld,$^5$ 
\newauthor
Amit Tagore,$^7$
Crescenzo Tortora,$^{21}$
Diego Tuccillo,$^{9,10}$
\newauthor
Manuel B. Valent\'in,$^{18}$
Santiago Velasco-Forero,$^{10}$
Gijs A. Verdoes Kleijn,$^{21}$
\newauthor
and Georgios Vernardos$^{21}$
\\
...
$^{6}$ Institute of Physics, Laboratory of Astrophysics, Ecole Polytechnique F\'ed\'erale de Lausanne (EPFL), Observatoire de Sauverny, 1290 Versoix, Switzerland \\
...
$^{16}$Aix Marseille Universit\'e, CNRS, LAM (Laboratoire d'Astrophysique de Marseille) UMR 7326, 13388, Marseille, France \\
$^{17}${Centro Federal de Educa\c{c}\~ao Tecnol\'ogica Celso Suckow da Fonseca, CEP 23810-000,  Itagua\'i, RJ, Brazil}\\
$^{18}${Centro Brasileiro de Pesquisas F\'isicas, CEP 22290-180, Rio de Janeiro, RJ, Brazil}\\
$^{19}${McWilliams Center for Cosmology, Department of Physics, Carnegie Mellon University, Pittsburgh, PA 15213, USA}\\
$^{20}${School of Computer Science, Carnegie Mellon University, Pittsburgh, PA 15213, USA}\\
$^{21}${Kapteyn Astronomical Institute, University of Groningen, Postbus 800, 9700 AV, Groningen, The Netherlands}\\
